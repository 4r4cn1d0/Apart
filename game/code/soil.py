...
class SoilLayer:
	def __init__(self, all_sprites, collision_sprites, level=None):
		...
		# sounds (commented out for Lambda Cloud - no audio support)
	...
	def get_hit(self, point):
		for rect in self.hit_rects:
			if rect.collidepoint(point):
				# self.hoe_sound.play()  # Commented out for Lambda Cloud - no audio support
	...
	def plant_seed(self, target_pos, seed):
		for soil_sprite in self.soil_sprites.sprites():
			if soil_sprite.rect.collidepoint(target_pos):
				# self.plant_sound.play()  # Commented out for Lambda Cloud - no audio support
